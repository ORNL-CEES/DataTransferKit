    ...
    const std::vector<double> &local_z_edges )
{
    ...
    auto local_node_global_ids_host = Kokkos::create_mirror_view(_local_node_global_ids);
    _local_node_coords =
        Kokkos::View<Coordinate **>( "node_coords", local_num_node, space_dim );
    auto local_node_coords_host = Kokkos::create_mirror_view(_local_node_coords);
    ...
    auto local_cell_global_ids_host = Kokkos::create_mirror_view(_local_cell_global_ids);
    _local_cell_connectivity = Kokkos::View<LocalOrdinal **>(
        "cell_connectivity", local_num_cell, cell_num_node );
    auto local_cell_connectivity_host = Kokkos::create_mirror_view(_local_cell_connectivity);
    _local_cell_center_coords =
        Kokkos::View<Coordinate **>( "cell_coords", local_num_cell, space_dim );
    auto local_cell_center_coords_host = Kokkos::create_mirror_view(_local_cell_center_coords);
    ...
    Kokkos::deep_copy(_local_cell_center_coords, local_cell_center_coords_host);
}
