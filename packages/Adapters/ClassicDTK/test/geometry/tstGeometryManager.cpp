...
TEUCHOS_UNIT_TEST( GeometryManager, geometry_manager_cylinder_test )
{
    ...
    TEST_FLOATING_EQUALITY( global_box.getBounds()[3] , my_size+99.0, 1.0e-14 );
    TEST_FLOATING_EQUALITY( global_box.getBounds()[4] , my_size+99.0, 1.0e-14 );
    TEST_FLOATING_EQUALITY( global_box.getBounds()[5] , my_size+98.5, 1.0e-14 );
}
...
TEUCHOS_UNIT_TEST( GeometryManager, geometry_manager_box_test )
{
    ...
    BoundingBox global_box = geometry_manager.globalBoundingBox();
    TEST_FLOATING_EQUALITY( global_box.getBounds()[0] , -dbl_size-99.0, 1.0e-14 );
    TEST_FLOATING_EQUALITY( global_box.getBounds()[1] , -dbl_size-99.0, 1.0e-14 );
    TEST_FLOATING_EQUALITY( global_box.getBounds()[2] , -dbl_size-99.0, 1.0e-14 );
    TEST_FLOATING_EQUALITY( global_box.getBounds()[3] , dbl_size+99.0, 1.0e-14 );
    TEST_FLOATING_EQUALITY( global_box.getBounds()[4] , dbl_size+99.0, 1.0e-14 );
    TEST_FLOATING_EQUALITY( global_box.getBounds()[5] , dbl_size+99.0, 1.0e-14 );
}
