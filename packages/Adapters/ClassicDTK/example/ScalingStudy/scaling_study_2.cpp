...
int main( int argc, char *argv[] )
{
    ...
    Teuchos::reduceAll<int, int>( *comm, Teuchos::REDUCE_SUM, 1,
                                  &local_test_failed, &global_test_failed );
    ...
    if ( my_rank == 0 )
    {
        ...
        {
            std::cout << std::endl
                      << "TEST FAILURE " << global_test_failed << std::endl;
        }
        else
        {
    ...
    if ( my_rank == 0 )
    {
        ...
        std::cout << "--------------------------------------------------"
                  << std::endl;
        std::cout << "Global min setup time (s):     " << global_min_setup_time
                  << std::endl;
        std::cout << "Global max setup time (s):     " << global_max_setup_time
                  << std::endl;
        std::cout << "Global average setup time (s): "
                  << global_average_setup_time << std::endl;
        std::cout << "--------------------------------------------------"
                  << std::endl;
        std::cout << "Global min apply time (s):     " << global_min_apply_time
                  << std::endl;
        std::cout << "Global max apply time (s):     " << global_max_apply_time
                  << std::endl;
