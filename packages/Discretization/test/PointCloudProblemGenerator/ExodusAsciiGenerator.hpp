        ...
        public PointCloudProblemGenerator<SourceDevice,TargetDevice>
{
  public:
    ...
    void createOneToOneProblem(
        ...
        Kokkos::View<Coordinate**,Kokkos::LayoutLeft,TargetDevice>& tgt_coords ) override;
    ...
    void createGeneralProblem(
        ...
        Kokkos::View<GlobalOrdinal*,Kokkos::LayoutLeft,TargetDevice>& tgt_gids ) override;
