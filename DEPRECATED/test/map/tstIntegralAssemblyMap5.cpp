//---------------------------------------------------------------------------//
/*!
 * \file tstIntegralAssemblyMap5.cpp
 * \author Stuart R. Slattery
 * \brief Integral assembly map unit test 5 for repeated geometries.
 */
//---------------------------------------------------------------------------//
...
TEUCHOS_UNIT_TEST( IntegralAssemblyMap, cylinder_test )
{
    ...
    // Every proc will have the same geometry.
...
//---------------------------------------------------------------------------//
// end tstIntegralAssemblyMap5.cpp
//---------------------------------------------------------------------------//
