 ...
 */
Teuchos::RCP<DataTransferKit::MeshBlock> buildMyMesh()
{
    ...
    // Make the quads.
    int num_quads = 4;
    Teuchos::ArrayRCP<DataTransferKit::MeshId> quad_handles( num_quads );
    Teuchos::ArrayRCP<DataTransferKit::MeshId> quad_connectivity( 4*num_quads );
...
TEUCHOS_UNIT_TEST( SharedDomainMap, shared_domain_map_test )
{
	...
	Teuchos::RCP< FieldEvaluator<DataTransferKit::MeshId,MyField> > 
	    source_evaluator = 
