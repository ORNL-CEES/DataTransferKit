//---------------------------------------------------------------------------//
/*!
 * \file tstAsynchronousMap2.cpp
 * \author Stuart R. Slattery
 * \brief asynchronous map unit test 2.
 */
//---------------------------------------------------------------------------//
...
#include <DTK_AsynchronousMap.hpp>
...
TEUCHOS_UNIT_TEST( AsynchronousMap, asynchronous_map_test2 )
{
	...
	new MeshManager<MyMesh>( mesh_blocks, comm, dim ) );
...
TEUCHOS_UNIT_TEST( AsynchronousMap, asynchronous_map_expanded_test2 )
{
    using namespace DataTransferKit;
...
// aren't in the mesh.
TEUCHOS_UNIT_TEST( AsynchronousMap, asynchronous_map_tiled_test2 )
{
    using namespace DataTransferKit;
...
// targets.
TEUCHOS_UNIT_TEST( AsynchronousMap, asynchronous_map_two_maps_test2 )
{
    using namespace DataTransferKit;
    ...
    // Setup and apply the asynchronous mapping 1.
    AsynchronousMap<MyMesh,MyField,dim> asynchronous_map_1( comm );
    asynchronous_map_1.setup( source_mesh_manager, target_coord_manager_1 );
    asynchronous_map_1.apply( source_evaluator, target_space_manager_1 );
    ...
    // Setup and apply the asynchronous mapping 2.
    AsynchronousMap<MyMesh,MyField,dim> asynchronous_map_2( comm );
    asynchronous_map_2.setup( source_mesh_manager, target_coord_manager_2 );
    asynchronous_map_2.apply( source_evaluator, target_space_manager_2 );
...
TEUCHOS_UNIT_TEST( AsynchronousMap, asynchronous_map_two_targets_test2 )
{
    using namespace DataTransferKit;
    ...
    // Setup asynchronous mapping.
    AsynchronousMap<MyMesh,MyField,dim> asynchronous_map( comm );
    asynchronous_map.setup( source_mesh_manager, target_coord_manager_1 );

    // Apply the asynchronous mapping 1.
    asynchronous_map.apply( source_evaluator, target_space_manager_1 );
    ...
    // Apply the asynchronous mapping 2.
    asynchronous_map.apply( source_evaluator, target_space_manager_2 );
