//---------------------------------------------------------------------------//
/*!
 * \file tstAsynchronousMap3.cpp
 * \author Stuart R. Slattery
 * \brief asynchronous map unit test 3.
 */
//---------------------------------------------------------------------------//
...
Teuchos::RCP<MyMesh> buildMyMesh( int my_rank, int my_size, int edge_length )
{
    ...
    return Teuchos::rcp(
	new MyMesh( vertex_handles, coords, tet_handles, tet_connectivity,
		    permutation_list ) );
}
...
TEUCHOS_UNIT_TEST( AsynchronousMap, asynchronous_map_test3 )
{
...
TEUCHOS_UNIT_TEST( AsynchronousMap, asynchronous_map_expanded_test3 )
{
    using namespace DataTransferKit;
...
// aren't in the mesh.
TEUCHOS_UNIT_TEST( AsynchronousMap, asynchronous_map_tiled_test3 )
{
    using namespace DataTransferKit;
