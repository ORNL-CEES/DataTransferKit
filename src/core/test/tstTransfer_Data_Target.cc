//----------------------------------*-C++-*----------------------------------//
/*!
 * \file   core/test/tstTransfer_Data_Target.cc
 * \author stuart
 * \date   Fri Nov 18 14:43:45 2011
 * \brief  
...
int main(int argc, char *argv[])
{
    ...
    {
        std::cout << "ERROR: While testing tstTransfer_Data_Target, " 
                  << err.what()
                  << endl;
        ut.numFails++;
    }
...
//---------------------------------------------------------------------------//
//                        end of tstTransfer_Data_Target.cc
//---------------------------------------------------------------------------//
